...
GEN_API_KEY = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"  # Remplacez par votre clé API
...
def main():
    ...
    st.title("Application d'analyse multimédia utilisant l'intelligence artificielle générative : Chatbot, Analyse d'Images, et Analyse de PDF avec Google Gemini")
